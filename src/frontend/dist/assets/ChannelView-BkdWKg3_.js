import { c as createLucideIcon, r as reactExports, u as useListUserConversations, a as useForwardChannelPost, b as useGetGroupAvatars, j as jsxRuntimeExports, D as Dialog, d as DialogContent, e as DialogHeader, f as DialogTitle, S as Search, I as Input, g as ScrollArea, L as LoaderCircle, B as Button, h as ue, i as useGetUserProfile, A as Avatar, k as AvatarImage, l as AvatarFallback, m as useGetChannelPostInteractions, n as useLikeChannelPost, o as useUnlikeChannelPost, p as useCommentOnChannelPost, q as useDeleteChannelPost, s as useEditChannelPost, t as useGiftGoldToPost, v as useRecordChannelPostView, w as useGetMyGoldBalance, x as DropdownMenu, y as DropdownMenuTrigger, E as EllipsisVertical, z as DropdownMenuContent, C as DropdownMenuItem, F as SquarePen, P as Pin, G as PinOff, T as Trash2, H as Heart, M as MessageCircle, J as Share2, K as Eye, N as Coins, O as Send, Q as Textarea, R as AlertDialog, U as AlertDialogContent, V as AlertDialogHeader, W as AlertDialogTitle, X as AlertDialogDescription, Y as AlertDialogFooter, Z as AlertDialogCancel, _ as AlertDialogAction, $ as useGetChannel, a0 as useGetChannelPosts, a1 as useFollowChannel, a2 as useUnfollowChannel, a3 as useAddChannelPost, a4 as useMediaUpload, a5 as usePinChannelPost, a6 as useUnpinChannelPost, a7 as useDeleteChannel, a8 as markChannelAsViewed, a9 as Skeleton, aa as ArrowLeft, ab as Users, ac as X, ad as Mic, ae as Image, af as Video, ag as useUpdateChannel, ah as Camera, ai as Label, aj as ChevronDown } from "./index-D5b2ht9R.js";
/**
...
function ChannelPostCard({
  ...
  const goldBalance = rawBalance !== void 0 ? Number(rawBalance) / 100 : null;
  reactExports.useEffect(() => {
  ...
  const handleGiftGold = async () => {
    ...
    try {
      ...
      ue.success(`Gifted ${amt.toFixed(2)} Gold successfully!`);
      setGiftOpen(false);
      setGiftAmount("");
    } catch (err) {
      ue.error(err instanceof Error ? err.message : "Failed to gift Gold");
    }
  };
  const handleLike = () => {
    if (likedByMe) {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 mt-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Button,
                      {
                        ...
                        disabled: giftGold.isPending || !giftAmount || Number.parseFloat(giftAmount) < 0.01 || goldBalance !== null && goldBalance < Number.parseFloat(giftAmount),
                        "data-ocid": `channel.post.gift.submit_button.${ocid}`,
                        style: {
                          background: "linear-gradient(135deg, oklch(0.76 0.13 72), oklch(0.65 0.11 65))",
                          color: "oklch(0.08 0.004 55)"
                        },
                        children: giftGold.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin" }) : "Send Gold"
                      }
                    )
                  ] })
                ]
